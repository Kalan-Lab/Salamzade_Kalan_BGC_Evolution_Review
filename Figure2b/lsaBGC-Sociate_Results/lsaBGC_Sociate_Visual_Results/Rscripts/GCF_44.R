...
heatmap.data <- read.table("/workspace/lab/kalanlab/salamzar/lsaBGC/minireview/Strep_albido/lsaBGC-Pan_Results_v1.0.9/lsaBGC_Sociate_Results/Tracks_for_Visual/GCF_44.txt", header=F, sep="\t")
...
pdf("/workspace/lab/kalanlab/salamzar/lsaBGC/minireview/Strep_albido/lsaBGC-Pan_Results_v1.0.9/Final_Results/Visualizations/lsaBGC_Sociate_Visual_Results/Plots/GCF_44.pdf", height=10, width=20)
